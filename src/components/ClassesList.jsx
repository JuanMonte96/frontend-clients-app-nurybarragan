...
export const ClassesList = () => {
    ...
    if (loading) return (
        <div className="flex items-center justify-center py-8 sm:py-12">
            <div className="text-center">
                ...
                <p className="mt-3 sm:mt-4 text-xs sm:text-sm md:text-base text-[var(--color-text)]">{t("common.loading")}...</p>
            </div>
        </div>
    )
    ...
    return (
        <section className="w-full">
            <div className="grid grid-cols-2 sm:grid-cols-1 lg:grid-cols-2 gap-3 sm:gap-4 md:gap-6">
