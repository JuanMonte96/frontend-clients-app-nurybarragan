  ...
  return (
    <div className="relative">
      ...
      <button
        ...
        className="flex items-center gap-2 px-3 sm:px-4 py-2 rounded-lg bg-[var(--color-primary)] hover:bg-[var(--color-primary-hover)] text-[var(--color-text)] transition-all duration-200 border border-[var(--color-primary)] text-xs sm:text-sm font-semibold"
